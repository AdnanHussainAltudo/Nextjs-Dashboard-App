      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-20">
          ...
          <div className="flex items-center gap-5">
            ...
            <Link
              href="/signup"
              className="flex items-center gap-5 self-start rounded-lg bg-transparent px-6 py-3 text-sm font-medium text-blue-500 border border-blue-500 transition-colors hover:bg-blue-200 md:text-base"
            >
